...
<head>
  ...
  <style>
    ...
    .user-icon {
      ...
      color: #17a2b8;; /* Color del ícono de usuario */
      padding: 5px;
      cursor: pointer;
    }
    .intro{
...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark ">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <span class="dropdown-item-text">Nombre de Usuario</span>
  ...
  <div class="container mt-4">
    ...
    <button type="button" class="btn btn-primary btn-block d-block d-lg-none" data-toggle="modal" data-target="#addAulaModal">
      Añadir Aula
    </button>
  </div>
        ...
        <tbody>
          ...
          ?>
              <tr>
                ...
                <td class="d-none d-lg-table-cell"><?php echo $row['capacidad']; ?></td>
                <td class="d-none d-lg-table-cell"><?php echo $row['ubicacion']; ?></td>
...
<div class="modal fade" id="addAulaModal" tabindex="-1" role="dialog" aria-labelledby="addAulaModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        <form id="addAulaForm">
          <div class="form-group">
            <label for="fotoInput">Foto del Aula <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Carga una foto del aula"></i></label>
            <input type="file" class="form-control" id="fotoInput" accept="image/*" required>
          </div>
          <div class="form-group">
            <label for="numeroInput">Número del Aula <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa el número del aula"></i></label>
            <input type="text" class="form-control" id="numeroInput" placeholder="Ej. 101" required>
          </div>
          <div class="form-group">
            <label for="ubicacionInput">Ubicación <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa la ubicación del aula"></i></label>
            <input type="text" class="form-control" id="ubicacionInput" placeholder="Ej. Edificio A" required>
          </div>
          <div class="form-group">
            <label for="capacidadInput">Capacidad del Aula <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa la capacidad del aula"></i></label>
...
<div class="modal fade" id="addReparacionesModal" tabindex="-1" role="dialog" aria-labelledby="addReparacionesModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form id="addReparacionForm">
          <div class="form-group">
            <label for="tituloReparacionInput">Título <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa el título de la reparación"></i></label>
            <input type="text" class="form-control" id="tituloReparacionInput" required>
          </div>
          <div class="form-group">
            <label for="descripcionMobiliarioInput">Descripción <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa la descripción del mobiliario"></i></label>
            <textarea class="form-control" id="descripcionMobiliarioInput" rows="3" required></textarea>
          </div>
          <div class="form-group">
            <label for="fechaReparacionInput">Fecha <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Selecciona la fecha de la reparación"></i></label>
...
<div class="modal fade" id="addMobiliarioModal" tabindex="-1" role="dialog" aria-labelledby="addMobiliarioModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form id="addMobiliarioForm">
          <div class="form-group">
            <label for="cantidadMobiliarioInput">Cantidad <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa la cantidad de mobiliario"></i></label>
          ...
          <div class="form-group">
            <label for="estadoMobiliarioInput">Estado <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa el estado del mobiliario"></i></label>
            <input type="text" class="form-control" id="estadoMobiliarioInput" required>
          </div>
          <div class="form-group">
            <label for="observacionMobiliarioInput">Observación <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="Ingresa alguna observación sobre el mobiliario"></i></label>
